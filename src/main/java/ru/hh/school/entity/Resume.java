...
public class Resume {
    ...
    @Id
    @GeneratedValue(generator = "resume_sequence", strategy = GenerationType.SEQUENCE)
    @SequenceGenerator(name = "resume_sequence", allocationSize = 10, sequenceName = "resume_id_seq")
    @Column(name = "id")
    private Integer id;
